...
export default function IntraNav({ modules, company }) {
  ...
  return (
    <aside className=" hidden z-30 xs:hidden text-xs top-0 text-nav fixed  h-screen xl:flex flex-col w-40 items-center justify-between  border-r border-r-slate-400 bg-white ">
